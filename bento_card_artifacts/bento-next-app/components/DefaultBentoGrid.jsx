  ...
  return (
    <div className="w-full mx-auto">
      <div className="grid grid-cols-12 gap-4">
        {/* 主卡片 */}
        <div className="col-span-12 md:col-span-6 bg-purple-50 rounded-2xl p-6 flex flex-col justify-between">
        ...
        {/* 卡片2 */}
        <div className="col-span-12 md:col-span-6 bg-purple-50/70 rounded-2xl p-6">
        ...
        {/* 卡片3 */}
        <div className="col-span-6 md:col-span-4 bg-purple-50/70 rounded-2xl p-6">
          <RotateCw size={40} className="text-purple-600 mb-4" />
        ...
        {/* 卡片5 */}
        <div className="col-span-12 md:col-span-4 bg-purple-50/70 rounded-2xl p-6">
          <Search size={40} className="text-purple-600 mb-4" />
          <h3 className="text-lg font-semibold">不只是搜索</h3>
          <p className="mt-2">海水退去，珍珠显现</p>
        </div>
        
        {/* 卡片6 */}
        <div className="col-span-12 bg-purple-50/70 rounded-2xl p-6 text-center">
          <Lightbulb size={40} className="text-purple-600 mx-auto mb-4" />
